...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth->auth.requestMatchers("/users/login","/api/v1/files/images/get/**","/api/v1/files/pdf/get/**","users/refresh-token"   ).permitAll().anyRequest().authenticated());
